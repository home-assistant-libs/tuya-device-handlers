...
@pytest.mark.parametrize(
    ...
    [
        ...
        # With InvertedIntegerTypeInformationEx: TypeInfo pre-inverts 52→48,
        # wrapper re-inverts 48→52. Double inversion cancels → correct value.
        (InvertedIntegerTypeInformationEx, 52, 70),
    ],
)
